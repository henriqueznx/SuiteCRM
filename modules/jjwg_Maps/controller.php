...
class jjwg_MapsController extends SugarController {
     ...
     */
    function Applicationgeocoded_counts() {
     ...
     * Google Maps - Geocode the Addresses
     */
    function Applicationgeocode_addresses() {
     ...
     */
    function Applicationadd_to_target_list() {
     ...
     */
    function Applicationexport_geocoding_addresses() {
     ...
     */
    function Applicationgeocoding_test() {
     ...
     */
    function Applicationreset_geocoding() {
     ...
     * Google Maps - geocoded_counts
     */
    function Applicationdelete_all_address_cache() {
     ...
     */
    function Applicationquick_radius() {
     ...
     */
    function Applicationquick_radius_display() {
     ...
     * Google Maps - Output the Page with IFrame to Map Markers
     */
    function Applicationmap_display() {
     ...
     */
    function Applicationmap_markers() {
    ...
    // end function Applicationmap_markers
