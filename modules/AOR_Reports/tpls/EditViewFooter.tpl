    ...
    <div class="panel-content">
        <div class="panel panel-default">
            <div class="panel-heading ">
                <a class="collapse" role="button" data-toggle="collapse" href="#aorpanel_1" aria-expanded="true">
                    <div class="col-xs-10 col-sm-11 col-md-11">&nbsp;</div>
                </a>
            </div>
            <div class="panel-body panel-collapse collapse in" id="aorpanel_1" aria-expanded="true">
                <div class="tab-content">
                    <div row="">
                        <div class="col-xs-4">
                            <div class="" id="detailpanel_fields_select">
                        ...
                        <div class="col-xs-8">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a id="tab0" href="#aor-tab-content-0" data-toggle="tab" class="hidden-xs">{$MOD.LBL_AOR_FIELDS_SUBPANEL_TITLE}</a>
                                </li>
                                <li>
                                    <a id="tab0" href="#aor-tab-content-1" data-toggle="tab" class="hidden-xs">{$MOD.LBL_AOR_CONDITIONS_SUBPANEL_TITLE}</a>
                                </li>
                                <li>
                                    <a id="tab0" href="#aor-tab-content-2" data-toggle="tab" class="hidden-xs">{$MOD.LBL_AOR_CHARTS_SUBPANEL_TITLE}</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active fade in" id="aor-tab-content-0">
                                    <table id="group_display_table">
                                        <tbody>
                                        <tr>
                                    ...
                                    <div class="tab-pane fade" id="aor-tab-content-1"></div>
                                    <div class="tab-pane fade" id="aor-tab-content-2"></div>
                                </div>
