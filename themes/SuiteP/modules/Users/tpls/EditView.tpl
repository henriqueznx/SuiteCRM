        ...
        <div class="tab-content" style="padding: 0; border: 0;">
                    ...
                    <div class="edit view">
                        <div class="row edit-view-row">
                            <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                <div class="col-xs-12 col-sm-2 label">{$MOD.LBL_EMAIL}:  {if $REQUIRED_EMAIL_ADDRESS}<span class="required" id="mandatory_email">{$APP.LBL_REQUIRED_SYMBOL}</span> {/if}</div>
                                <div class="col-xs-12 col-sm-10 edit-view-field ">{$NEW_EMAIL}</div>
                            </div>
                        </div>
                        <div class="row edit-view-row">
                            <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                <div class="col-xs-12 col-sm-2 label">{$MOD.LBL_EMAIL_LINK_TYPE} {sugar_help text=$MOD.LBL_EMAIL_LINK_TYPE_HELP WIDTH=450}</div>
                                <div class="col-xs-12 col-sm-10 edit-view-field "><select>{$EMAIL_LINK_TYPE}</select></div>
                            </div>
                        </div>
                        {if !$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}
                            <div class="row edit-view-row">
                                <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                    <div class="col-xs-12 col-sm-2 label" id="mail_smtpserver_label">{$MOD.LBL_EMAIL_PROVIDER}</div>
                                    <div class="col-xs-12 col-sm-10 detail-view-field ">{$mail_smtpdisplay}<input id='mail_smtpserver' name='mail_smtpserver' type="hidden" value='{$mail_smtpserver}' /></div>
                                </div>
                            </div>
                         {if !empty($mail_smtpauth_req) }
                             <div class="row edit-view-row">
                                 <div class="col-xs-12 col-sm-6 edit-view-row-item">
                                     <div class="col-xs-12 col-sm-4 label">{$MOD.LBL_MAIL_SMTPUSER}</div>
                                     <div class="col-xs-12 col-sm-8 edit-view-field "><input type="text" id="mail_smtpuser" name="mail_smtpuser" class="form-control" size="25" maxlength="64" value="{$mail_smtpuser}" tabindex='1' ></div>
                                 </div>
                                 <div class="col-xs-12 col-sm-6 edit-view-row-item">
                                     <div class="col-xs-12 col-sm-4 label">{$MOD.LBL_MAIL_SMTPPASS}</div>
                        ...
                        {/if}
                            <div class="row edit-view-row" id="test_outbound_settings_tr">
                                <div class="col-xs-12 col-sm-6 edit-view-row-item">
                                    <div class="col-xs-12 col-sm-4 label"></div>
                                    <div class="col-xs-12 col-sm-8 edit-view-field "><button class="btn btn-default" onclick="startOutBoundEmailSettingsTest(); return false;">{$APP.LBL_EMAIL_TEST_OUTBOUND_SETTINGS}</button></div>
                                </div>
                            </div>
                ...
                {if $CHANGE_PWD == '1'}
                    <div id="generate_password">
                        <div class="edit view">
                            ...
                            <div class="row edit-view-row" id='generate_password_old_password' {if ($IS_ADMIN && !$ADMIN_EDIT_SELF)} style='display:none' {/if}>
                                <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                    <div class="col-xs-12 col-sm-2 label">  {$MOD.LBL_OLD_PASSWORD}</div>
                                    <div class="col-xs-12 col-sm-10 edit-view-field "><input name='old_password' id='old_password' type='password' tabindex='2' onkeyup="password_confirmation();" ></div>
                                </div>
                            </div>
                            <div class="row edit-view-row">
                                <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                    ...
                                    <div class="col-xs-12 col-sm-10 edit-view-field dataField">
                            ...
                            <div class="row edit-view-row">
                                <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                    <div class="col-xs-12 col-sm-2 label">{$MOD.LBL_CONFIRM_PASSWORD}</div>
                                    <div class="col-xs-12 col-sm-10 edit-view-field dataField"><input name='confirm_new_password' id='confirm_pwd' style ='' type='password' tabindex='2' onkeyup="password_confirmation();"  ></div>
                                </div>
                            </div>
                            <div class="row edit-view-row">
                                <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                    ...
                                    <div class="col-xs-12 col-sm-10 edit-view-field dataField">
                                        <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey='{$APP.LBL_SAVE_BUTTON_KEY}' class='btn btn-danger' id='save_new_pwd_button' LANGUAGE=javascript onclick='if (set_password(this.form)) window.close(); else return false;' type='submit' name='button' value='{$APP.LBL_SAVE_BUTTON_LABEL}'>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {*
                     ...
                     <div class="row edit-view-row">
                         <div class="col-xs-12 col-sm-12 edit-view-row-item">
                             <div class="col-xs-12 col-sm-2 label"></div>
                             <div class="col-xs-12 col-sm-10 edit-view-field "></div>
                         </div>
                     </div>
                     <div class="row edit-view-row">
                         <div class="col-xs-12 col-sm-6 edit-view-row-item">
                             <div class="col-xs-12 col-sm-4 label"></div>
                             <div class="col-xs-12 col-sm-8 edit-view-field "></div>
                         </div>
                         <div class="col-xs-12 col-sm-6 edit-view-row-item">
                             <div class="col-xs-12 col-sm-4 label"></div>
                             <div class="col-xs-12 col-sm-8 edit-view-field "></div>
            ...
            <div class="tab-pane-NOBOOTSTRAPTOGGLER fade" id='tab-content-{{$tabCount}}' >
                <div id="themepicker" style="display:{$HIDE_FOR_GROUP_AND_PORTAL}">
                    <div class="row edit-view-row">
                        <div class="col-xs-12 col-sm-12 edit-view-row-item">
                            <div class="col-xs-12 col-sm-2 label">{$MOD.LBL_THEME}</div>
                            <div class="col-xs-12 col-sm-10 edit-view-field ">
                                <div>
                                    <select name="user_theme" tabindex='366'id="user_theme_picker">
                                        {$THEMES}
                                    </select>
                                </div>
                            </div>
            ...
            <div class="tab-pane-NOBOOTSTRAPTOGGLER fade" id='tab-content-{{$tabCount}}' >
                <div id="settings_suitep" >
                    ...
                    <div class="row edit-view-row">
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_RECEIVE_NOTIFICATIONS} {sugar_help text=$MOD.LBL_RECEIVE_NOTIFICATIONS_TEXT}
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 -view-field">
                                <!-- simple hidden start -->
                                <input name='receive_notifications' class="checkbox" tabindex='12' type="checkbox" value="12" {$RECEIVE_NOTIFICATIONS}>
                        ...
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_MAILMERGE|strip_semicolon} {sugar_help text=$MOD.LBL_MAILMERGE_TEXT }
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 edit-view-field " type="name" field="name">
                                <!-- simple hidden start -->
                                <input tabindex='3' name='mailmerge_on' class="checkbox" type="checkbox" {$MAILMERGE_ON}>
                                <!-- simple hidden finish -->
                            </div>
                        </div>
                    </div>
                    <div class="row edit-view-row">
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_EXPORT_DELIMITER|strip_semicolon} {sugar_help text=$MOD.LBL_EXPORT_DELIMITER_DESC }
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 edit-view-field " type="name" field="name">
                        ...
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_EXPORT_CHARSET|strip_semicolon} {sugar_help text=$MOD.LBL_EXPORT_CHARSET_DESC }
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 edit-view-field " type="name" field="name">
                        ...
                        <div class="row edit-view-row">
                            <div class="col-xs-12 col-sm-12 edit-view-row-item">
                                ...
                                <div class="col-xs-12 col-sm-10 detail-view-field " type="name" field="name">
                                    ...
                                    <input id="external_auth_only" name="external_aut_only" type="checkbox" class="checkbox" {$EXTERNAL_AUTH_ONLY_CHECKED}>
                                    <input type='hidden' value='0' name='external_auth_only'><input type='checkbox' value='1' name='external_auth_only' {$EXTERNAL_AUTH_ONLY_CHECKED}>
                                    <!-- simple hidden finish -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row edit-view-row">
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_USE_REAL_NAMES|strip_semicolon} {sugar_help text=$MOD.LBL_USE_REAL_NAMES_DESC }
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 edit-view-field " type="name" field="name">
                                <!-- simple hidden start -->
                                <input tabindex='3' name='use_real_names' class="checkbox" type="checkbox" {$USE_REAL_NAMES}>
                                <!-- simple hidden finish -->
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_REMINDER|strip_semicolon} {sugar_help text=$MOD.LBL_REMINDER_TEXT }
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 edit-view-field ">
                ...
                <div id='locale_suitep'>
                    ...
                    <div class="row edit-view-row">
                        <div class="col-xs-12 col-sm-6 edit-view-row-item">
                            ...
                            <div class="col-xs-12 col-sm-4 label col-1-label">
                                <!-- LABEL -->
                                {$MOD.LBL_DATE_FORMAT|strip_semicolon} {sugar_help text=$MOD.LBL_DATE_FORMAT_TEXT }
                            </div>
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-8 edit-view-field ">
                ...
                <div id='calendar_options_suitep'>
                    ...
                    <div class="row edit-view-row">
                        <div class="col-xs-12 col-sm-12 edit-view-row-item">
                            ...
                            <!-- /DIV inside  -->
                            <!-- phone (version 1) -->
                            <div class="col-xs-12 col-sm-10 edit-view-field " type="name" field="name">
                                <!-- simple hidden start -->
                ...
                <div id="settings" style="display:{$HIDE_FOR_GROUP_AND_PORTAL}">
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
                        ...
                        <div class="row edit-view-row">
                            <th width="100%" ><h4><slot>{$MOD.LBL_USER_SETTINGS}</slot></h4></th>
                        </div>
                        <div class="row edit-view-row">
                ...
                <div id="layout">
                    <table class="edit view" border="0" cellpadding="0" cellspacing="1" width="100%">
                        <tbody>
                        <div class="row edit-view-row">
                            <th ><h4>{$MOD.LBL_LAYOUT_OPTIONS}</h4></th>
                        </div>
                        <div class="row edit-view-row" id="use_group_tabs_row" style="display: {$DISPLAY_GROUP_TAB};">
                ...
                <div id="calendar_options" style="display:{$HIDE_FOR_GROUP_AND_PORTAL}">
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
                        <div class="row edit-view-row">
                            <th ><h4>{$MOD.LBL_CALENDAR_OPTIONS}</h4></th>
                        </div>
                        <div class="row edit-view-row">
