...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        ...
        <div class="desktop-toolbar" id="toolbar">
            ...
            {literal}
                <script>
                  ...
                  $('.desktop-toolbar').change(windowResize);
        ...
        <div class="mobile-bar">
            ...
            {literal}
            <script>
              var fixLongModuleName = function () {
                $('.modulename [module]').text($('.modulename [module]').attr('full_text'));
                if ($(window).width() > 1250) {
                  return;
                } else if ($(window).width() >= 750 && $(window).width() <= 1250) {
                  $('.mobileheader').addClass('hidden');

                  var dth = $('.navbar-fixed-top  > .container-fluid').outerHeight();

                  $('.mobileheader').removeClass('hidden');
                  while ($('.navbar-fixed-top  > .container-fluid').outerHeight() > dth) {
                    $('.modulename [module]').text($('.modulename [module]').text().substring(
                      0, $('.modulename [module]').text().length - 1));
                  }
                } else if ($(window).width() < 750) {
                  while (($('.modulelinks').width() + 60) > $('.navbar-header').width()) {
                    $('.modulename [module]').text($('.modulename [module]').text().substring(
                      0, $('.modulename [module]').text().length - 1));
                  }
                }
              ...
              // Fix mobile header
              $('.modulename [module]').attr('full_text', $('.modulename [module]').text());
              $(document).ready(fixLongModuleName);
              $(window).resize(fixLongModuleName);
            </script>
            {/literal}
        </div>
