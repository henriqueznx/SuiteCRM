<?php
global $SUITECRM_ROOT, $module,  $MODULES, $BUILD_ROOT, $module_ROOT, $MODULES_ROOT, $EXTENSION_ROOT, $module_TASKS_ROOT, $SUITE2PSR_ROOT;
/**
...
//    $module_source_path = realpath($SUITECRM_ROOT.$m);
    ...
    $module_destination_path = $module_ROOT.$module;
