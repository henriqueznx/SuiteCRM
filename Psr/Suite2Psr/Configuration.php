...
global $SUITECRM_ROOT, $VENDOR, $APPLICATION, $MODULES, $BUILD_ROOT, $APPLICATION_ROOT, $MODULES_ROOT, $EXTENSION_ROOT, $APPLICATION_TASKS_ROOT, $SUITE2PSR_ROOT,
       $MAP_FILES;
/**
 * ROOT DIRECTORIES
 */
...
$MODULES = array(
       'modules'.DIRECTORY_SEPARATOR => 'SuiteCRM'.DIRECTORY_SEPARATOR,
       'metadata'.DIRECTORY_SEPARATOR => 'SuiteCRM'.DIRECTORY_SEPARATOR.'Relationships'.DIRECTORY_SEPARATOR,
);
