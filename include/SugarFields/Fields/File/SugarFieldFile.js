    ...
    if(obj != null) {
      $.each(obj, function (key, value) {
        $("#attachment_container").append('<div><a href="index.php?entryPoint=download&id=' +
          ...
          value.name +
          '</a><input type="button" class="button" id="remove_button_' + value.id +
          '" value="' + SUGAR.language.get("app_strings", "LBL_REMOVE") + '" onclick="SUGAR.field.file.deleteAttachment(\'' + value.id + '\',\'' + value.module + '\',this);">');
      });
    }
  });
  SUGAR.field.file = {
    deleteAttachment: function (elemBaseName, docTypeName, elem) {
      ...
      var moduleValue = "";
      if(docTypeName == "Attachments") {
        moduleValue = elem.form.module.value;
        moduleRecord = elem.form.record.value;
        elem.form.module.value = "Attachments";
        elem.form.record.value = elemBaseName;
      }
      ...
      if(moduleValue != ""){
        elem.form.module.value = moduleValue;
        elem.form.record.value = moduleRecord;
      }
      ...
      return function (text) {
        if (docTypeName == "Attachments") {
          $("#file_" + elemBaseName).hide();
          $("#remove_button_" + elemBaseName).hide();
