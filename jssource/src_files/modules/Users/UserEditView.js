...
function verify_data(form) {
  ...
  if ($('[name="required_password"]').val() == '1'
    && $('[name="new_password"]').val() == "") {
    add_error_style('EditView', $('[name="new_password"]').attr('name'),
  ...
  if ($('[name="return_id"]').val() != '' && (typeof(form.reports_to_id) != "undefined") && ($('[name="return_id"]').val() == $('[name="reports_to_id"]').val())) {
...
function set_chooser() {
  ...
  $('[name="display_tabs_def"]').val(display_tabs_def);
  $('[name="hide_tabs_def"]').val(hide_tabs_def);
  $('[name="remove_tabs_def"]').val(remove_tabs_def);
}
